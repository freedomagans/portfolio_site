...
// Pagination setup
$perPage = $contentSettings['projects_per_page'];
        ...
        <div class="row g-4">
            <?php if (!empty($projects)) : ?>
                <?php foreach ($projects as $index => $project) : ?>
                    <?php
                    // Prepare project images for carousel
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?= ($index % 3) * 100; ?>">
                        <div class="project-card-modern">
                            ...
                            <div class="project-content">
                                ...
                                require_once MODELS_PATH . 'ProjectViewModel.php';
                                ...
                                $commentCount = $commentModel->countApprovedByProject($project['id']);
                                $views = $viewModel->countByProject($project['id']);
                                $likes = $likeModel->countByProject($project['id']);
                                $hasLiked = $likeModel->hasLiked($project['id'], $ipHash);
                                ?>

                                <?php
                                // Load once (outside foreach recommended but still works here)
                                require_once MODELS_PATH . 'ProjectLikeModel.php';
                                require_once MODELS_PATH . 'ProjectViewModel.php';
                                require_once MODELS_PATH. 'CommentModel.php';

                                require_once MODULE_PATH . 'projects/feedback_buttons.php';
                                ...
                                <div class="project-metrics">
                                    ...
                                    // --- Comments ---
                                    $commentCount = $commentModel->countApprovedByProject($project['id']);
                                    echo renderCommentsButton($project['id'], $commentCount);
                                    ...
                                    echo renderLikeButton($project['id'], $likes, $hasLiked);
                                    ?>
